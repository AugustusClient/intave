...
public final class NewCollider implements Collider {
  @Override
  ...
  private void calculateBackOffFromEdge(User user, double length, Physics.PhysicsProcessorContext context) {
    Player player = user.player();
