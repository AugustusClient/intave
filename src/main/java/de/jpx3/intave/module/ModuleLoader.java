...
public final class ModuleLoader {
  ...
  public void setup() {
    ...
    prepareModule(PacketSubscriptionLinker.class, ModuleSettings.builder().requiresProtocolLib().requires(Requirements.intaveEnabled()).doNotLinkSubscriptions().bootAt(BootSegment.STAGE_5).build());
